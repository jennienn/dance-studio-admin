-- 같은 수강권은 같은 날 최대 2개의 서로 겹치지 않는 개인레슨을 예약할 수 있다.
drop index if exists idx_solo_booking_cycle_date;
create index idx_solo_booking_cycle_date on solo_bookings(cycle_id, booking_date)
